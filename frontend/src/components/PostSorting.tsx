          ...
          <div className="flex flex-col space-y-4 p-6">
            <div className="flex items-center">
              ...
              <select
                ...
                className="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
              >
                {fields.map((field) => (
